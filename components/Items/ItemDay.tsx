          ...
          <div className='flex flex-col gap-4'>
            {Days.map((DayItem) => (
              <>
                {DayItem.StartTime ? (
                  <div
                    className={cn('bg-ariBlackDarker rounded shadow flex flex-col gap-y-0 gap-x-2 py-2 ',
                      {
                  ...
                  >
                    ...
                    {(DayItem.Price ? (
                      <div
                        className={cn('flex flex-col gap-y-0 gap-x-2 border-t border-ariGrey w-full mt-2 pt-2 ',
                          {
                            'text-center justify-center items-center': centered
                          },
                          {
