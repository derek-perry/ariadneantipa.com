        ...
        <ul className='list-none flex flex-col'>
          {navLinksMenu.map((item) => (
            <li className='grow' key={item.title}>
              <LinkInternal title={item.title} href={item.href} className='py-3 px-3 max-sm:px-2 border-b border-ariBlackDarker hover:bg-ariBlackDarkest flex text-sm leading-[18px] tracking-[0.01em] transition-all font-bold no-underline'>
                <p>
                  {item.title}
                </p>
              </LinkInternal>
